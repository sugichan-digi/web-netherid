...
function initHeaderPopups() {
  ...
  $actions.html(
    ...
    '<span>マイページ</span>' +
    '</a></li>' +
    '<li><a href="/profile/" class="user-menu-dropdown-nav-item">' +
    ...
    '<span>お問い合わせ</span>' +
    '</a></li>' +
    '<li><a href="/account/" class="user-menu-dropdown-nav-item user-menu-dropdown-nav-item--danger">' +
...
var KRATOS_ERROR_MESSAGES = {
  4000001: 'エラーが発生しました。ページを再読み込みして最初からお試しください。',
  ...
  4070005: 'リカバリーコードが正しくありません。もう一度お試しください。',
};
